...
public final class PacketUtils {
    ...
    public static WrappedDataWatcher setMetadata(WrappedDataWatcher watcher, int index, Class c, Object value) {
        watcher.setObject(
                new WrappedDataWatcher.WrappedDataWatcherObject(index,
                        com.comphenix.protocol.wrappers.WrappedDataWatcher.Registry.get(c)),
                value);

        return watcher;
    }

    public static WrappedDataWatcher setMetadata(WrappedDataWatcher watcher, int index,
    ...
    public static void sendAttributePacket(Player player, int entityId, String attributeName, double value) {
        PacketContainer packet = protocolManager.createPacket(PacketType.Play.Server.UPDATE_ATTRIBUTES);
        packet.getIntegers().write(0, entityId);

        List<com.comphenix.protocol.wrappers.WrappedAttribute> attributes = new ArrayList<>();
        com.comphenix.protocol.wrappers.WrappedAttribute attribute = com.comphenix.protocol.wrappers.WrappedAttribute
                .newBuilder()
