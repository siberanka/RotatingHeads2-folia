...
public class HeadInteraction {
    ...
    public void register() {
        protocolManager.addPacketListener(
                new PacketAdapter(Main.getInstance(), ListenerPriority.NORMAL, PacketType.Play.Client.USE_ENTITY) {
                    @Override
                    public void onPacketReceiving(PacketEvent e) {
                        ...
                        SchedulerUtils.runTask(Main.getInstance(), p, () -> Bukkit.getPluginManager().callEvent(event));
